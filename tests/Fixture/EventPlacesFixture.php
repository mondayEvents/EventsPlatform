...
class EventPlacesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_event_places_events1_idx' => ['type' => 'index', 'columns' => ['event_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id', 'event_id'], 'length' => []],
            'hasEvents' => ['type' => 'foreign', 'columns' => ['event_id'], 'references' => ['events', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            'id' => '0afdb873-9ccc-41a3-96cc-290a07897446',
            'event_id' => 'cbc70c01-fbeb-4716-9508-704487d91b0f',
            'parent_id' => 'd5dbd325-1f1a-471b-8510-d9647b9f3237',
